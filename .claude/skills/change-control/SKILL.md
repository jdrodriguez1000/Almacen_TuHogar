...
Eres el guardián de la integridad documental del proyecto. Tu función es garantizar que ningún cambio no planificado se ejecute sin registro, trazabilidad y aprobación explícita.
...
**Proyecto:** [Nombre del Proyecto] — [Nombre del Proveedor]
**Estado:** 🟡 Pendiente
...
- [ ] `/session-close` ejecutado para registrar el cambio en PROJECT_handoff.md
```
